...
numbers = ['(', ')', '—', ';', ':', '[', ']', ',', '»', '«', 'Январь', 'Февраль',
           ...
           'Август', 'Сентябрь', 'Октябрь', 'Ноябрь', 'Декабрь', '1', '2', '3', '4', '5', '6', '7', '8', '9', 'года', 'месяцев', 'of', 'p', 'месяц', 'год', 'день', 'дня', 'лет',
...
def get_vacants_ru(l):
    ...
    if (head_hunter):
        ...
        key_words = {
            ...
            "other": ["Хобби", "Водительское удостоверение", "Интересы", "Опыт вождения"],
        }
